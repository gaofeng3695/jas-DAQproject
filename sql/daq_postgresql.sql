...
create or replace view v_daq_pipe_segment_cross as  select s.oid,s.pipe_segment_name as name,s.start_stake_oid,s.end_stake_oid,s.pipe_segment_code as code,1 as type from daq_pipe_segment s where s.active=1
union all
select s.oid,s.cross_name as name,s.start_stake_oid,s.end_stake_oid, s.cross_code as code, 2 as type from daq_cross s where s.active=1
/**********线路物资基本信息end***************/
/**********线路物资检查信息begin***************/
