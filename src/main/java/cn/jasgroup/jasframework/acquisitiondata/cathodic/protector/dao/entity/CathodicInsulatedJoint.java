package cn.jasgroup.jasframework.acquisitiondata.cathodic.protector.dao.entity;
...
/**
  ...
  * @version v1.0.0.1。
  * @since JDK1.8。
  *<p>创建日期：2018年7月19日 下午5:07:22。</p>
 */
@CommonSaveConfig(
	scene = "/cathodicInsulatedJoint/save"
)
@CommonUpdateConfig(
	scene = "/cathodicInsulatedJoint/update"
)
@CommonDeleteConfig(
	scene = "/cathodicInsulatedJoint/delete"
)
@UniqueConstraints(
    strategys ={
...
@JdbcEntity(name="daq_cathodic_insulated_joint")
public class CathodicInsulatedJoint extends CommonJdbcEntity {
