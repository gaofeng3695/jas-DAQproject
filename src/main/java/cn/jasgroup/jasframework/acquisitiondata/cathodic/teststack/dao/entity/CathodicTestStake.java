package cn.jasgroup.jasframework.acquisitiondata.cathodic.teststack.dao.entity;
...
/**
  ...
  * @version v1.0.0.1。
  * @since JDK1.8。
  *<p>创建日期：2018年7月19日 下午5:52:23。</p>
 */
@CommonSaveConfig(
	scene = "/cathodicTestStake/save"
)
@CommonUpdateConfig(
	scene = "/cathodicTestStake/update"
)
@CommonDeleteConfig(
	scene = "/cathodicTestStake/delete"
)
@Point(
	x="pointx",
	y="pointy" ,
...
@JdbcEntity(name="daq_cathodic_test_stake")
public class CathodicTestStake extends CommonJdbcEntity {
