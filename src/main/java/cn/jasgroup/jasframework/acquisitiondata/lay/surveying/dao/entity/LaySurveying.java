package cn.jasgroup.jasframework.acquisitiondata.lay.surveying.dao.entity;
 ...
 * 
  ...
  * @version v1.0.0.1。
  * @since JDK1.8。
  *<p>创建日期：2018年7月13日 上午11:36:41。</p>
 */

@CommonSaveConfig(
	scene = "/laySurveying/save"
)
@CommonUpdateConfig(
	scene = "/laySurveying/update"
)
@CommonDeleteConfig(
