...
public class OpenGisService extends CommonDataJdbcService {
    ...
    public void updateGeom(BaseEntity baseEntity){
        ...
        // 调用gi解析函数
        double[][] path = new double[][]{{Double.parseDouble(startPointx),Double.parseDouble(startPointy),Double.parseDouble(startPointz)},
                {Double.parseDouble(endPointx),Double.parseDouble(endPointy),Double.parseDouble(endPointz)}};
