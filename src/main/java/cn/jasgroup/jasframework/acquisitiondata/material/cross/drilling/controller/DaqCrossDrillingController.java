package cn.jasgroup.jasframework.acquisitiondata.material.cross.drilling.controller;
...
public class DaqCrossDrillingController {
	...
	public Object get(HttpServletRequest request, @RequestParam String oid){
		...
		try {
			...
			DaqCrossDrillingBo bo = this.drillingService.get(oid);
			result = new SimpleResult<DaqCrossDrillingBo>(bo);
		} catch (Exception e) {
			e.printStackTrace();
