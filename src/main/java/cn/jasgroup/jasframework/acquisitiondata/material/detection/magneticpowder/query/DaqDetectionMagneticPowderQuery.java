...
/**
 * @description 磁粉检测主表query
 * @author zhangyi
 * @date 2018年7月12日上午9:44:45
 * @version V1.0
 * @since JDK 1.80
 */

@QueryConfig(
	scene = "/detectionMagneticPowder/getPage", 
	resultClass = DaqDetectionMagneticPowderBo.class,
	queryBeforeProcess = {
		@Process(service = "daqInjectService" , method = "injectDataAuthoritySql(dataAuthoritySql)")
	}
)
public class DaqDetectionMagneticPowderQuery extends BaseJavaQuery{
