package cn.jasgroup.jasframework.acquisitiondata.material.cross.drilling.dao.entity;
...
@CommonSaveConfig(
	scene = "/crossDrilling/save"
)
@CommonUpdateConfig(
	scene = "/crossDrilling/update"
)
@CommonDeleteConfig(
	scene = "/crossDrilling/delete"
)
...
@JdbcEntity(name="daq_cross_drilling")
public class DaqCrossDrilling extends CommonJdbcEntity {
