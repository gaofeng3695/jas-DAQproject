package cn.jasgroup.jasframework.acquisitiondata.material.cross.boxculvert.dao;
 ...
 * @description 箱涵穿越dao
 * @author zhangyi
 * @date 2018年7月16日下午3:43:53
 * @version V1.0
 * @since JDK 1.80
 */

@Component
public class DaqCrossBoxCulvertDao extends BaseJdbcDao {
	...
	public Boolean approve(String oid, Integer approveStatus) {
		Boolean b = false;
		String sql = "update daq_cross_box_culvert set approve_status = ? where active=1"
				+ " and oid =?";
	...
	public DaqCrossBoxCulvertBo get(String oid){
		...
		return (DaqCrossBoxCulvertBo) this.baseJdbcDao.queryForObject(sql, new Object[]{oid}, DaqCrossBoxCulvertBo.class);
	}
}
