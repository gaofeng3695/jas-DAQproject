package cn.jasgroup.jasframework.acquisitiondata.material.cross.drillingblasting.dao.entity;
 ...
 * @version v1.0.0.1。
 * @since JDK1.8。
 * <p>创建日期：2018年7月17日 上午10:22:02。</p>
 */

@CommonSaveConfig(
	scene = "/crossDrillingBlasting/save"
)
@CommonUpdateConfig(
	scene = "/crossDrillingBlasting/update"
)
@CommonDeleteConfig(
	scene = "/crossDrillingBlasting/delete"
)
@CommonDeleteBatchConfig(
	scene = "/crossDrillingBlasting/deleteBatch"
)
@Line(
...
@JdbcEntity(name="daq_cross_drilling_blasting")
public class DaqCrossDrillingBlasting extends CommonJdbcEntity {
	 ...
	 * 稳管措施 
	 */
	private String steadyTubeMeasures; 

	/**
	 * 钻爆围堰等级 
	 */
	private String cofferdamGrade; 
	...
	public String getSteadyTubeMeasures() {
		return steadyTubeMeasures; 
	}

	public void setSteadyTubeMeasures(String steadyTubeMeasures) {
		this.steadyTubeMeasures = steadyTubeMeasures; 
		super.setField("steadyTubeMeasures");
	}

	public String getCofferdamGrade() {
		return cofferdamGrade; 
	}

	public void setCofferdamGrade(String cofferdamGrade) {
		this.cofferdamGrade = cofferdamGrade; 
		super.setField("cofferdamGrade");
	}
