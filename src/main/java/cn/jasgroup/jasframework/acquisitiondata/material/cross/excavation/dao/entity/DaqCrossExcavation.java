package cn.jasgroup.jasframework.acquisitiondata.material.cross.excavation.dao.entity;
 ...
 * @version v1.0.0.1。
 * @since JDK1.8。
 * <p>创建日期：2018年7月16日 上午10:16:39。</p>
 */

@CommonSaveConfig(
	scene = "/crossExcavation/save"
)
@CommonUpdateConfig(
	scene = "/crossExcavation/update"
)
@CommonDeleteConfig(
	scene = "/crossExcavation/delete"
)
@CommonDeleteBatchConfig(
	scene = "/crossExcavation/deleteBatch"
	)
@Line(
