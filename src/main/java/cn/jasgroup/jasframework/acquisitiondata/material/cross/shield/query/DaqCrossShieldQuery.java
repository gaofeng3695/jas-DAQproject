package cn.jasgroup.jasframework.acquisitiondata.material.cross.shield.query;
 ...
 * @description 盾构隧道穿越
 * @author zhangyi
 * @date 2018年7月17日上午10:04:50
 * @version V1.0
 * @since JDK 1.80
 */

@QueryConfig(
	scene = "/crossShield/getPage",
	resultClass = DaqCrossShieldBo.class,
	queryBeforeProcess = {
		@Process(service = "daqInjectService" , method = "injectDataAuthoritySql(dataAuthoritySql)")
	}
)
public class DaqCrossShieldQuery extends BaseJavaQuery{
