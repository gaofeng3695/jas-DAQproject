package cn.jasgroup.jasframework.acquisitiondata.material.cross.drilling.query;
 ...
 * @description 定向钻穿越
 * @author zhangyi
 * @date 2018年7月16日下午4:09:02
 * @version V1.0
 * @since JDK 1.80
 */

@QueryConfig(
	scene = "/crossDrilling/getPage",
	resultClass = DaqCrossDrillingBo.class,
	queryBeforeProcess = {
		@Process(service = "daqInjectService" , method = "injectDataAuthoritySql(dataAuthoritySql)")
	}
)
public class DaqCrossDrillingQuery extends BaseJavaQuery {
