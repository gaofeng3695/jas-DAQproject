package cn.jasgroup.jasframework.acquisitiondata.material.cross.boxculvert.dao.entity;
...
@CommonSaveConfig(
	scene = "/crossBoxCulvert/save"
)
@CommonUpdateConfig(
	scene = "/crossBoxCulvert/update"
)
@CommonDeleteConfig(
	scene = "/crossBoxCulvert/delete"
)
@CommonDeleteBatchConfig(
	scene = "/crossBoxCulvert/deleteBatch"
)
@Line(
...
@JdbcEntity(name="daq_cross_box_culvert")
public class DaqCrossBoxCulvert extends CommonJdbcEntity {
