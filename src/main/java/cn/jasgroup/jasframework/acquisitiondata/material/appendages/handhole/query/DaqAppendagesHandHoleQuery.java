...
public class DaqAppendagesHandHoleQuery extends BaseJavaQuery {
	...
	public String getSql() {
		String sql =  "select t.*,"
				+ " d1.code_name as handHoleNameCodeName,"
				+ " d2.code_name as handHoleTypeName,"
				+ "	p.project_name,"
				+ "	l.pipeline_name,"
				+ "	dt.tenders_name,"
				...
				+ " left join sys_domain d1 on d1.code_id = t.hand_hole_name"				
				+ " left join sys_domain d2 on d2.code_id = t.hand_hole_type"				
