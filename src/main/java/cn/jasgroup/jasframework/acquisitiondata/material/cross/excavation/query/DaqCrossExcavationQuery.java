package cn.jasgroup.jasframework.acquisitiondata.material.cross.excavation.query;
 ...
 * @description 开挖query
 * @author zhangyi
 * @date 2018年7月16日上午10:40:29
 * @version V1.0
 * @since JDK 1.80
 */

@QueryConfig(
	scene = "/crossExcavation/getPage",
	resultClass = DaqCrossExcavationBo.class,
	queryBeforeProcess = {
		@Process(service = "daqInjectService" , method = "injectDataAuthoritySql(dataAuthoritySql)")
	}
)
public class DaqCrossExcavationQuery extends BaseJavaQuery{
