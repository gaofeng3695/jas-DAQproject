package cn.jasgroup.jasframework.acquisitiondata.material.cross.shield.dao.entity;
 ...
 * @version v1.0.0.1。
 * @since JDK1.8。
 * <p>创建日期：2018年7月17日 上午9:55:49。</p>
 */

@CommonSaveConfig(
	scene = "/crossShield/save"
)
@CommonUpdateConfig(
	scene = "/crossShield/update"
)
@CommonDeleteConfig(
	scene = "/crossShield/delete"
)
@CommonDeleteBatchConfig(
	scene = "/crossShield/deleteBatch"
)
@Line(
...
@JdbcEntity(name="daq_cross_shield")
public class DaqCrossShield extends CommonJdbcEntity {
