package cn.jasgroup.jasframework.acquisitiondata.material.cross.across.dao.entity;
 ...
 * @version v1.0.0.1。
 * @since JDK1.8。
 * <p>创建日期：2018年7月17日 上午10:58:23。</p>
 */

@CommonSaveConfig(
	scene = "/crossAcross/save"
)
@CommonUpdateConfig(
	scene = "/crossAcross/update"
)
@CommonDeleteConfig(
	scene = "/crossAcross/delete"
)
@CommonDeleteBatchConfig(
	scene = "/crossAcross/deleteBatch"
)
@Line(
...
@JdbcEntity(name="daq_cross_across")
public class DaqCrossAcross extends CommonJdbcEntity {
