package cn.jasgroup.jasframework.acquisitiondata.material.cross.boxculvert.query;
 ...
 * @description 箱涵穿越
 * @author zhangyi
 * @date 2018年7月16日下午3:36:14
 * @version V1.0
 * @since JDK 1.80
 */

@QueryConfig(
	scene = "/crossBoxCulvert/getPage",
	resultClass = DaqCrossBoxCulvertBo.class,
	queryBeforeProcess = {
		@Process(service = "daqInjectService" , method = "injectDataAuthoritySql(dataAuthoritySql)")
	}
)
public class DaqCrossBoxCulvertQuery extends BaseJavaQuery {
