package cn.jasgroup.jasframework.acquisitiondata.material.cross.pipejacking.query;
...
/**
 * @description 顶管穿跨越query
 * @author zhangyi
 * @date 2018年7月16日下午2:26:18
 * @version V1.0
 * @since JDK 1.80
 */

@QueryConfig(
	scene = "/crossPipeJacking/getPage",
	resultClass = DaqCrossPipeJackingBo.class,
	queryBeforeProcess = {
		@Process(service = "daqInjectService" , method = "injectDataAuthoritySql(dataAuthoritySql)")
	}
)
public class DaqCrossPipeJackingQuery extends BaseJavaQuery {
