...
public class ReworkWeldDao {
	...
	public void changeGeomColumn(String weldOid){
		String sql = "update daq_weld_rework_weld set geom = (select geom from daq_construction_weld where oid=?";
		this.baseJdbcTemplate.batchExecute(sql,new Object[]{weldOid});
	}
}
