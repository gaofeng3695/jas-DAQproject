...
public class ConstructionWeldQuery extends BaseJavaQuery{
	...
	public String getQuerySql() {
		String sql = "SELECT cw.*,pro.project_code, pi.pipeline_code, te.tenders_code, vpsc.name as pipe_segment_or_cross_name, ms.median_stake_code,"
					+ " u.unit_name as construct_unit_name, pu.unit_name as supervision_unit_name, wu.work_unit_code, d.code_name as weld_type_name, "
					+ "dm.code_name as weld_method_name,pf.code_name as front_pipe_type_name,bp.code_name as back_pipe_type_name "
