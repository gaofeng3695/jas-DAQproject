...
//		var note=$("#tt").tree("find",noteid);
//		var prinumber=note.attributes.privilegeNumber;
//		$("#tt").tree("options").url='./getAllChildrenPrivilege.do?priviligeNumber='+prinumber;
//		$("#tt").tree("reload",note.target);
		var treeObj = $.fn.zTree.getZTreeObj("tt");
