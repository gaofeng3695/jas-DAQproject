Vue.component('jas-base-module-title', {
  ...
  template: [
    '<div style="height:30px;padding:10px 0 0 10px;box-sizing: border-box;">',
...
Vue.component('jas-list-wrapper', {
	...
	template: [
		...
		'	<div ref="searchWrapper" class="searchWrapper" style="border-bottom: 1px solid #e4e7ed;overflow:hidden;box-sizing:border-box;">',
