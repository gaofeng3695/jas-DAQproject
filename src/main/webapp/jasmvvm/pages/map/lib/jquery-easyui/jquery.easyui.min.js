...
var t=$(_6);
var _8={};
var s=$.trim(t.attr("dataaccess-options"));
if(s){
...
_1f9.proxy=$("<div class=\"window-proxy\"><iframe style=\"position: absolute; z-index: -1; width: 100%; height: 100%; top: 0;left:0;scrolling:no;\" frameborder=\"0\"></div>").insertAfter(_1f9.window);
}
...
//_1f9.pmask.css({zIndex:$.fn.window.defaults.zIndex++,left:e.dataaccess.left,top:e.dataaccess.top,width:_1f9.window._outerWidth(),height:_1f9.window._outerHeight()});
